    ...
    return (
        <footer className="py-12 px-4 border-t border-[#262626] mt-12">
            ...
            <div className="flex justify-center gap-6 mb-8 text-gray-400">
                ...
                {/* GitHub */}
                <a href="https://github.com/FH-EngineeringClub" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-center text-xs text-gray-500">
                @2025 Foothill Engineering Club. All rights reserved.
            </div>
        </footer >
    );
}
